...
import availableProductsData from "../assets/availableProductsData";
...
const AvailableProducts: React.FC = () => {
  ...
  const currentProducts = availableProductsData.slice(startIndex, startIndex + PRODUCTS_PER_PAGE);
  const totalPages = Math.ceil(availableProductsData.length / PRODUCTS_PER_PAGE);


  return (
    <div className="products-container">
      <h2 className="products-title">{t("header.available", "Available Products")}</h2>
      <Divider icon="" text="🌿V🌿  " />
